/**
 * Tooltip — overlay tooltip shown when visible.
 *
 * Renders children with an optional tooltip text positioned
 * above, below, or to the right. Uses simple column/row layout
 * rather than absolute positioning.
 *
 * Features:
 *   - Auto-positioning: flips when tooltip would overflow terminal edges
 *   - Delay: show tooltip after a delay in ms
 *   - Arrow: optional arrow character pointing from tooltip to target
 */
...
export const Tooltip = React.memo(function Tooltip(rawProps: TooltipProps): React.ReactElement {
  ...
  const props = usePluginProps("Tooltip", rawProps as unknown as Record<string, unknown>) as unknown as TooltipProps;
  ...
  // Handle delay logic with imperative refs
