/**
 * SearchInput — text input with search icon prefix.
 *
 * Wraps the TextInput component with a magnifying glass icon.
 * Passes all input behavior through to TextInput.
 */
...
export const SearchInput = React.memo(function SearchInput(rawProps: SearchInputProps): React.ReactElement {
  ...
  const props = usePluginProps("SearchInput", rawProps as unknown as Record<string, unknown>) as unknown as SearchInputProps;
  const {
    value,
    onChange,
    onSubmit,
