/**
 * Paragraph — text block with automatic bottom spacing.
 *
 * Wraps text with consistent margin-bottom for
 * readable document-like layouts.
 */
...
export const Paragraph = React.memo(function Paragraph(rawProps: ParagraphProps): React.ReactElement {
  const props = usePluginProps("Paragraph", rawProps as unknown as Record<string, unknown>) as unknown as ParagraphProps;
