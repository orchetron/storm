/**
 * Static — renders items that should only be computed once.
 *
 * Each item is wrapped in a memoized component so that previously
 * rendered items are never re-rendered when new items are added.
 */
