 ...
 *
 * Renders a keyboard key in a visually distinct way: [Ctrl+C] with
 * background tinting and bold text. Makes keyboard shortcuts look
 * polished in help text.
 */
...
export const Kbd = React.memo(function Kbd(rawProps: KbdProps): React.ReactElement {
  ...
  const props = usePluginProps("Kbd", rawProps as unknown as Record<string, unknown>) as unknown as KbdProps;
