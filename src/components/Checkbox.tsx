 ...
 *
 * Renders [✓] or [ ] with an optional label.
 * Responds to space/enter key via useInput when onChange is provided.
 */
...
export const Checkbox = React.memo(function Checkbox(rawProps: CheckboxProps): React.ReactElement {
  ...
  const props = usePluginProps("Checkbox", rawProps as unknown as Record<string, unknown>) as unknown as CheckboxProps;
