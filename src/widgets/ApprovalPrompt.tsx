/**
 * ApprovalPrompt — generic tool approval UI.
 *
 * Displays a tool name, risk level, optional parameters, and a set of
 * keyboard-selectable options (default: approve / deny / always approve).
 * Uses `useInput` (eager hook) for key handling.
 *
 * @module
 */
...
export interface ApprovalOption {
  ...
  key: string;
  /** Display text next to the key. */
  label: string;
  /** Color for the key character. */
  color: string;
}
...
export interface ApprovalPromptProps {
  ...
  /** Risk level. */
  risk?: string;
  /** Tool parameters to display. */
  params?: Record<string, unknown>;
  /** Approval options — default: y/n/a. */
  options?: ApprovalOption[];
  /** Called when user presses an option key. */
...
export const ApprovalPrompt = React.memo(function ApprovalPrompt(rawProps: ApprovalPromptProps): React.ReactElement {
  ...
  const props = usePluginProps("ApprovalPrompt", rawProps as unknown as Record<string, unknown>) as unknown as ApprovalPromptProps;
  const {
    tool,
    risk,
    params,
